...
class App extends Component {
  ...
  _onMouseMove(e) {
    ...
    if (currTime > this.state.lastBubbleStamp + getRandomArbitrary(minBubbleTime, maxBubbleTime)) {
      ...
      this.state.bubbles.push({x:e.clientX, y: e.screenY, size: getRandomArbitrary(minBubbleSize, maxBubbleSize), direction: direction, lastTurnTime: currTime, lastGrowTime: currTime});
